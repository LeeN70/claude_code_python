"""System prompts and environment information."""
import os
import platform
...
def get_system_prompt() -> str:
    """Get main system prompt for the assistant."""
...
IMPORTANT: Always be concise with fewer than 4 lines of text (not including tool use or code), unless the user asks for detail."""


def get_agent_prompt() -> str:
    """Get system prompt for agent tasks."""
    env_info = get_env_info()
